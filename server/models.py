...
class Quidroo(models.Model):
    ...
    phone = models.CharField(max_length=1500, verbose_name="Telephone number",blank=True)
    ...
    confirm_female_cofounder = models.CharField(max_length=1500, verbose_name="Is there atleast one female cofounder/owner",blank=True)
