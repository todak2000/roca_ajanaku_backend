...
class Quidroo(models.Model):
    ...
    email = models.EmailField(max_length=90, verbose_name="Email", blank=True)
    phone = models.CharField(max_length=15, verbose_name="Telephone number",blank=True)
    company = models.CharField(max_length=15, verbose_name="Company",blank=True)

    type_business = models.CharField(max_length=15, verbose_name="Type of Business",blank=True)
    address = models.CharField(max_length=15, verbose_name="Company Address",blank=True)
